...
import TextSearches from './textSearch';
...
const WDTextSearch = styled(TextSearches)`
  label {
    font-size: 18px;
...
const WDVoiceSearchWrapper = styled.div`
  ...
  ${'' /* background-color: #ffffff;
  box-shadow: ${palette('shadows', 1)}; */} border: 0;
...
const TextSearch = WithDirection(WDTextSearch);
