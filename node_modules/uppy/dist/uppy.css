...
.UppyDashboardItem-progressIndicator {
  ...
  .UppyDashboard--wide .UppyDashboardItem-progressIndicator {
    width: 55px;
    height: 55px; }
...
.UppyDashboardItem.is-error .UppyDashboardItem-progressIndicator {
  width: 18px;
  height: 18px; }
  .UppyDashboard--wide .UppyDashboardItem.is-error .UppyDashboardItem-progressIndicator {
    width: 28px;
    height: 28px; }
...
.UppyDashboardItem.is-complete .UppyDashboardItem-progressIndicator {
  ...
  height: 18px;
  opacity: 1; }
  .UppyDashboard--wide .UppyDashboardItem.is-complete .UppyDashboardItem-progressIndicator {
    width: 25px;
    height: 25px; }
...
.Browser-viewType--grid .BrowserTable-row {
  position: relative; }

.Browser-viewType--grid .BrowserTable-column {
  padding: 14px 10px; }

.Browser-viewType--grid .BrowserTable-checkbox {
  position: absolute;
  top: 7px;
  right: 7px;
  margin-right: 0; }
...
.Browser-doneBtn {
  ...
  width: 50px;
  height: 50px; }
  .UppyDashboard--wide .Browser-doneBtn {
    width: 60px;
    height: 60px; }
...
.UppyStatusBar.is-waiting .UppyStatusBar-actionBtn--upload {
  background-color: #4A90E2;
  color: #fff; }
  .UppyStatusBar.is-waiting .UppyStatusBar-actionBtn--upload:hover {
    background-color: #1b5dab; }
