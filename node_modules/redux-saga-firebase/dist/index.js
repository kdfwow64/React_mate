...
var ReduxSagaFirebase = function () {
  function ReduxSagaFirebase(firebaseApp, firestoreDb) {
  ...
  (0, _createClass3.default)(ReduxSagaFirebase, [{
    ...
    value: function _getCollection(pathOrRef) {
      return typeof pathOrRef === 'string' ? this.firestoreDb.collection(pathOrRef) : pathOrRef;
    }
  }, {
    key: '_getDocument',
    value: function _getDocument(pathOrRef) {
      return typeof pathOrRef === 'string' ? this.firestoreDb.doc(pathOrRef) : pathOrRef;
    }
  }]);
